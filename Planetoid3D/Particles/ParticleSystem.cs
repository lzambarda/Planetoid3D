...
namespace Planetoid3D {
    ...
    public abstract class ParticleSystem : DrawableGameComponent {
        ...
        EffectParameter effectCamForwardParameter;
        EffectParameter effectCamPositionParameter;
        ...
        //These values are passed to every particle
        float size;
        Color color;
        ...
        void LoadParticleEffect() {
            ...
            effectCamForwardParameter = parameters["CamForward"];
            effectCamPositionParameter = parameters["CamPosition"];
            ...
            parameters["Sampler+Texture"].SetValue(texture);
        ...
        /// <summary>
        /// Set the size that will be passed to all new particles.
        /// </summary>
        ...
        /// <summary>
        /// Set the color that will be passed to all new particles, since
        /// the BlendState used for drawing is Addictive, black will make
        /// the particle invisibile and white will not change particles.
        /// </summary>
        ...
        public void SetCamera(Camera camera) {
            ...
            effectCamForwardParameter.SetValue(Vector3.Normalize(camera.tempTar - camera.position));
            effectCamPositionParameter.SetValue(camera.position);
        }
        ...
        public void AddParticle(Vector3 position, Vector3 velocity) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                particles[firstFreeParticle * 4 + i].Color = color;
            }
